...
var TimelineIcon = require('@material-ui/icons/Timeline');
var ScatterPlotIcon = require('@material-ui/icons/ScatterPlot');
...
var TimelineIcon__default = /*#__PURE__*/_interopDefaultLegacy(TimelineIcon);
  ...
  _createClass(DataStore, [{
    ...
    value: function initialize() {
      ...
      if (!this.initialized) {
        ...
        return axios__default["default"].get(url, config).then(function (res) {
    ...
    value: function loadSegment(blockId, segmentId) {
      ...
      return axios__default["default"].get(url, config).catch(function (err) {
...
function ListItemNonEmpty(props) {
  if (props.value) {
    return /*#__PURE__*/React__default["default"].createElement(ListItem__default["default"], null, /*#__PURE__*/React__default["default"].createElement(ListItemText__default["default"], {
      primary: props.value,
...
function InfoPanel(props) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(Popover__default["default"], {
    ...
    dense: true
  }, /*#__PURE__*/React__default["default"].createElement(ListItemNonEmpty, {
    label: "Name",
    ...
    return /*#__PURE__*/React__default["default"].createElement(ListItemNonEmpty, {
      key: value,
      label: label,
      value: value
    });
...
function SegmentSelect(props) {
  ...
  if (props.consistent) {
    menuItemAll = /*#__PURE__*/React__default["default"].createElement(MenuItem__default["default"], {
      value: "all"
    }, "All");
  }
  ...
  }, "Segment"), /*#__PURE__*/React__default["default"].createElement(Select__default["default"], {
...
function SignalSelect(props) {
  ...
  if (props.show && props.labels[segmentId]) {
    ...
    }, "Signal"), /*#__PURE__*/React__default["default"].createElement(Select__default["default"], {
...
function LoadingAnimation(props) {
  ...
  if (props.loading) {
    return /*#__PURE__*/React__default["default"].createElement(CircularProgress__default["default"], {
...
function HeaderPanel(props) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  }, !props.disableChoice && /*#__PURE__*/React__default["default"].createElement(ButtonGroup__default["default"], {
    color: "primary",
  ...
  }, /*#__PURE__*/React__default["default"].createElement(TimelineIcon__default["default"], null))), /*#__PURE__*/React__default["default"].createElement(Tooltip__default["default"], {
  ...
  }, /*#__PURE__*/React__default["default"].createElement(ScatterPlotIcon__default["default"], null)))), /*#__PURE__*/React__default["default"].createElement(SegmentSelect, {
    segmentId: props.segmentId,
    consistent: props.consistent,
    onChange: handleChangeSegment,
    labels: props.labels
  }), /*#__PURE__*/React__default["default"].createElement(SignalSelect, {
    segmentId: props.segmentId,
  ...
  }, /*#__PURE__*/React__default["default"].createElement(InfoIcon__default["default"], {
    fontSize: "medium",
    color: "primary"
  }))), /*#__PURE__*/React__default["default"].createElement(InfoPanel, {
    id: id,
    source: props.source,
    info: props.metadata,
    open: infoOpen,
    ...
    "aria-label": "download",
    className: classes.roundButtons
  }, /*#__PURE__*/React__default["default"].createElement(GetAppIcon__default["default"], {
    fontSize: "medium",
    color: "primary"
  }))), /*#__PURE__*/React__default["default"].createElement(LoadingAnimation, {
    loading: props.loading
  }), !props.disableChoice && !props.showSignals && !props.showSpikeTrains && /*#__PURE__*/React__default["default"].createElement("span", null, "Click signals (", /*#__PURE__*/React__default["default"].createElement(TimelineIcon__default["default"], {
    fontSize: "small",
    style: {
      verticalAlign: "sub"
    }
  }), ") and/or spike trains (", /*#__PURE__*/React__default["default"].createElement(ScatterPlotIcon__default["default"], {
    fontSize: "small",
    style: {
      verticalAlign: "sub"
    }
...
function GraphPanel(props) {
  ...
  if (props.show) {
    ...
    return /*#__PURE__*/React__default["default"].createElement(Plot__default["default"], {
      data: data,
      layout: {
        margin: {
          l: 50,
...
function Visualizer(props) {
  ...
  var _React$useState13 = React__default["default"].useState(1),
  ...
  var _React$useState25 = React__default["default"].useState(""),
      _React$useState26 = _slicedToArray(_React$useState25, 2),
      errorMessage = _React$useState26[0],
      setErrorMessage = _React$useState26[1];

  var _React$useState27 = React__default["default"].useState(false),
      _React$useState28 = _slicedToArray(_React$useState27, 2),
      loading = _React$useState28[0],
      setLoading = _React$useState28[1];

  var datastore = React__default["default"].useRef(new DataStore(props.source, props.baseUrl || defaultBaseUrl));
  React__default["default"].useEffect(function () {
    if (props.segmentId) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", null, /*#__PURE__*/React__default["default"].createElement(HeaderPanel, {
    source: props.source,
    ioType: props.ioType,
    ...
    loading: loading
  }), /*#__PURE__*/React__default["default"].createElement(ErrorPanel, {
    message: errorMessage
  }), /*#__PURE__*/React__default["default"].createElement(GraphPanel, {
    data: signalData,
    axisLabels: axisLabels,
    show: showSignals,
    width: props.width,
    height: props.height
  }), /*#__PURE__*/React__default["default"].createElement(SpikeTrainPanel, {
    data: spikeData,
